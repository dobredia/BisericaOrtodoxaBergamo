...
<!-- 
The template is not my property. 

The template is from site http://all-free-download.com/free-website-templates/church_573.html
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!-- Font under license http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL -->
        ...
        <div id="templatemo_container">
            <div id="templatemo_header">  	
                <div id="out_mission_section">
                    <h1>Biserica Ortodoxa </h1>
                    <h1>din Bergamo</h1>      
                </div>   
                <div id="daily_bible_verse_section">
                    <h1>Hramul Bisericii:</h1>
                    <h3>Sfantul Apostol Toma</h3>
                </div>
            </div> <!-- end of header -->
<?php
    $authenticated = isset($_SESSION['authenticated']) ? $_SESSION['authenticated'] : FALSE;
    if (isset ($_GET['admin']) && !$authenticated){    
           include_once './admin/auth.php';
    } elseif($authenticated) {
           print '<script type="text/javascript" src="js/admin.js"></script>';
